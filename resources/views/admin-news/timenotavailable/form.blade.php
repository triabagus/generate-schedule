...
<div class="form-group">
    <label>
     ...
     {!! Form::select('lecturers', $lecturers, isset($timenotavailables->lecturers_id) ? $timenotavailables->lecturers_id : '' ,['class' => 'form-control select2 to-select','id' => 'lecturers', 'required', 'placeholder' => 'Pilih Guru']) !!}
